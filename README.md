...
## Sample violating files
- `bad_example.py` — breaks the Python rules (each violation marked `# VIOLATION:`)
- `BadExample.java` — breaks the Java rules (each violation marked `// VIOLATION:`)
